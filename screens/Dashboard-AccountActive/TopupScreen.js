        ...
        <View style={styles.container}>
            ...
            <View style={{ position: 'absolute', left: 10, top: 0 }}>
                <TouchableOpacity onPress={() => navigation.goBack()} >
                    <Image source={require('../../assets/back.png')} style={{ height: 17, width: 12, marginTop: 33, }} />

                </TouchableOpacity>
            </View>

            <Image source={require('../../assets/LogoReply.png')} style={{ height: 80, width: 100, alignSelf: 'center' }} />



            <View style={[styles.PickerView, { backgroundColor: '#92919614', marginTop: 70, borderWidth: 1, borderColor: '#92919614' }]}>
                <TextInput placeholder="Amount" placeholderTextColor={'white'} style={{ marginLeft: 10, color: 'white' }}
                    value={amount}
            ...
            <View style={{ borderBottomColor: '#92919614', borderWidth: 1, marginVertical: 20, width: '80%', alignSelf: 'center' }}></View>
            <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'center', marginBottom: 30 }}>
                <View style={{ borderColor: 'white', borderWidth: 1, height: 31, borderRadius: 7, justifyContent: 'center', marginRight: 10, width: 66 }}>
                    <TouchableOpacity onPress={() => { setAmount('₦500') }}>
                        <Text style={{ color: 'white', fontSize: 14, fontWeight: '400', fontFamily: 'roboto', textAlign: 'center' }}> ₦500</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ borderColor: 'white', borderWidth: 1, height: 31, borderRadius: 7, justifyContent: 'center', marginRight: 10, width: 66 }}>
                    <TouchableOpacity onPress={() => { setAmount('₦1000') }}>
                        <Text style={{ color: 'white', fontSize: 14, fontWeight: '400', fontFamily: 'roboto', textAlign: 'center' }}>₦1000</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ borderColor: 'white', borderWidth: 1, height: 31, borderRadius: 7, justifyContent: 'center', marginRight: 10, width: 66 }}>
                    <TouchableOpacity onPress={() => { setAmount('₦300') }}>
                        <Text style={{ color: 'white', fontSize: 14, fontWeight: '400', fontFamily: 'roboto', textAlign: 'center' }}>₦3000</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ borderColor: 'white', borderWidth: 1, height: 31, borderRadius: 7, justifyContent: 'center', marginRight: 10, width: 66 }}>
                    <TouchableOpacity onPress={() => { setAmount('₦5000') }}>
                        <Text style={{ color: 'white', fontSize: 14, fontWeight: '400', fontFamily: 'roboto', textAlign: 'center' }}>₦5000</Text>
                    </TouchableOpacity>
                </View>
            ...
            <View style={{ height: 41.39, width: 192, alignSelf: 'center', backgroundColor: '#FF1313', borderRadius: 27, marginTop: '10%', justifyContent: 'center' }}>
                <TouchableOpacity onPress={() => { fromTopup = true; navigation.navigate('ReviewSumary', fromTopup) }}>
                    <Text style={{ fontSize: 15, fontWeight: '600', fontFamily: 'robotobold', color: 'white', textAlign: 'center' }} >Continue</Text>
                </TouchableOpacity>
            </View>
                ...
                <BlurView intensity={120}
                    ...
                    <View style={{ flex: 1, }}>
                        {/* <View style={{ flexDirection: 'row', marginHorizontal: 2, backgroundColor: '#00000040', height: 40, justifyContent: 'space-between', marginVertical: 6, alignItems: 'center' }}>
                            ...
                            <AntDesign name="right" size={rf(12)} color="transparent" />
                        </View> */}
