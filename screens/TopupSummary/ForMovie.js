...
export default function FromMovie({ navigation, route }) {
        ...
        <View style={styles.container}>
            ...
            <View style={{ justifyContent: 'center', flex: 1 }}>
                ...
                <View style={{ marginVertical: 59, marginBottom: 11, flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: '10%' }}>
                    ...
                    <Text style={{ color: 'white', fontSize: 14, alignSelf: 'center', fontWeight: '400', fontFamily: 'roboto' }}>₦300.00</Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: '10%', marginBottom: 19, }}>
                    <Text style={{ color: 'white', fontSize: 14, alignSelf: 'center', fontWeight: '400', fontFamily: 'roboto' }}>Fee</Text>
                    <Text style={{ color: 'white', fontSize: 14, alignSelf: 'center', fontWeight: '400', fontFamily: 'roboto', marginRight: 15 }}>₦0.00</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', fontWeight: '400', marginHorizontal: '10%', marginBottom: 49 }}>
                    ...
                    <Text style={{ color: 'white', fontSize: 14, alignSelf: 'center', fontFamily: 'roboto' }}>₦300.00</Text>
                </View>
                ...
                <View style={{ height: 41.39, width: '46%', alignSelf: 'center', backgroundColor: '#FF1313', borderRadius: 27, marginTop: '10%', justifyContent: 'center' }}>
                    <TouchableOpacity onPress={() => { navigation.navigate('GiftRedeem', { fromTopup, fromMovie }) }}>
